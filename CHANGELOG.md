...
### Changed
- Missing timer files (`TimerBeforeSpawn.txt`, `TimerDuringSpawn.txt`, `Hints.txt`) are now generated locally from built-in defaults instead of being downloaded from the GitHub release.
