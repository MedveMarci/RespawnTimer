# RespawnTimer ![Downloads](https://img.shields.io/github/downloads/MedveMarci/RespawnTimer/total)
...
- Option for hiding the timer interface at the settings of the game. **EXILED only** (PluginAPI Work in progress)
