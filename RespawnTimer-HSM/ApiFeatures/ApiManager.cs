...
public static class ApiManager
{
    ...
    private const string Name = "RespawnTimer";
    ...
    internal static string SendLogsAsync(string content)
    {
        try
        {
            var url = $"{ApiBase}/api/v1/plugin/{Uri.EscapeDataString(Name)}/log";
            ...
            {
                content,
                plugin_version = RespawnTimer.Singleton.Version.ToString(),
