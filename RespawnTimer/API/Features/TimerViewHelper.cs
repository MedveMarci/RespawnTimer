...
public partial class TimerView
{
    ...
    public static int CiOffset { get; set; } = 13;
    public static int NtfOffset { get; set; } = 19;
    ...
    private void SetMinutesAndSeconds()
    {
        ...
        var miniCiTime =
            TimeSpan.FromSeconds(miniCi?.Timer.TimeLeft ?? 0);
        var miniNtfTime =
            TimeSpan.FromSeconds(miniNtf?.Timer.TimeLeft ?? 0);
