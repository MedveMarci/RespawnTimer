...
public partial class TimerView
{
    ...
    public static void AddTimer(string name)
    {
        ...
        var directoryPath = Path.Combine(RespawnTimerRuei.RespawnTimerRueiDirectoryPath, name);
    ...
    public static bool TryGetTimerForPlayer(Player player, out TimerView timerView)
    {
        ...
        // Check by group name
        if (RespawnTimerRuei.Singleton.Config!.Timers.TryGetValue(groupName, out var timerName))
        {
